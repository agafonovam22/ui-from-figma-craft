...
export const categoryMapping: Record<string, string[]> = {
  ...
  'Силовые тренажеры': ['870', '865', '857'], // Утяжелители (870), ручки эспандера (865), фитнес наборы (857)
...
export const categoryKeywords: Record<string, string[]> = {
  ...
  'Силовые тренажеры': ['утяжелители', 'гантели', 'штанга', 'силовой', 'фитнес набор', 'эспандер'],
