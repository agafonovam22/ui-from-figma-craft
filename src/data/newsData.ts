...
export const newsItems: NewsItem[] = [
  ...
  },
  {
    ...
    categoryColor: 'bg-blue-600',
    date: '6.09.2023',
    title: 'Новинка - Уже в продаже: Гребной тренажер CardioPower RE50',
    description: 'Гребной тренажер CardioPower RE50 - профессиональная модель для тренировки всех групп мышц.',
  ...
  },
  {
    ...
    categoryColor: 'bg-blue-600',
    date: '06.09.2023',
    title: 'Новинка - Уже в продаже: Вертикальный велотренажер CardioPower B35',
    description: 'Вертикальный велотренажер CardioPower B35 - профессиональная модель с современным дизайном для эффективных кардиотренировок.',
