          ...
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="overflow-hidden relative rounded-lg" style={brandSlug === 'smith' ? { minHeight: 'auto' } : { height: '250px' }}>
              <img 
                ...
                className={brandSlug === 'smith' ? "w-full object-cover" : "w-full h-full object-cover"}
                style={brandSlug === 'smith' ? { height: 'calc(100% + 2px)', objectPosition: 'center right' } : { objectPosition: 'center right' }}
              />
