          ...
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              {brandSlug !== 'peach-builder' && (
                <div className="order-2 lg:order-1 lg:pr-8">
                  <h2 className="text-3xl font-benzin text-gray-900 mb-6">
                    {brandSlug === 'true' ? 'Инвестиция в долгосрочный результат' : brandSlug === 'bowflex' ? 'Поддержка в каждом движении' : brandSlug === 'schwinn' ? 'Широкая линейка для любых потребностей' : 'Немецкая надежность в каждой детали'}
                  </h2>
                  <div className="space-y-4">
                    <p className="text-gray-600 text-sm leading-relaxed font-manrope">
