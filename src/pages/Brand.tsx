                  ...
                  <div className="space-y-6">
                    <div>
                      <h3 className="font-benzin text-gray-900 mb-3">Фитнес-клубы премиум-класса</h3>
                       <p className="text-gray-600 text-sm font-manrope" style={{ lineHeight: '1.1', border: brandSlug === 'true' ? '2px solid red' : 'none' }}>
                         для коммерческого использования с высокой нагрузкой (DEBUG: brandSlug = {brandSlug})
                       </p>
                    </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <img 
                  ...
                  style={{ border: brandSlug === 'true' ? '5px solid blue' : '2px solid green' }}
                />
              </div>
            </div>
          </div>
