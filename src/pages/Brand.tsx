              ...
              <div className="order-2 lg:order-1 lg:pr-8">
                ...
                {brandSlug === 'cardio-power' ? (
                  ...
                  <>
                    ...
                    <>
                      <p className="text-gray-600 text-sm leading-relaxed mb-6 font-manrope">
                        INSPIRE предлагает полный спектр оборудования для профессионального и домашнего использования: многофункциональные силовые станции, кардиотренажеры, скамьи и стойки, рамы и машины Смита, специализированные мультистанции.
                      </p>
                      <p className="text-gray-600 text-sm leading-relaxed mb-6 font-manrope">
                        Профессиональные тренеры выбирают INSPIRE за безупречное качество и продуманную эргономику. Владельцы фитнес-клубов ценят надежность и долговечность, снижающие эксплуатационные расходы.
                      </p>
                      <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                        С момента основания INSPIRE успешно завоевал рынки Северной Америки, Европы и Азии, став синонимом американского качества в фитнес-индустрии.
                      </p>
                    </>
                 ) : brandSlug === 'smith' ? (
                   <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                     ...
                     <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                       Наше оборудование проходит многоступенчатое тестирование: от проверки каждой детали до 24/7 тестов на износ. Результат — тренажеры, которые сохраняют безупречную работу при экстремальных нагрузках. Гарантия на раму и сертификаты международных стандартов — подтверждение нашего подхода к качеству.
                     </p>
                   ) : (
                  <>
                    <p className="text-gray-600 text-sm leading-relaxed mb-6 font-manrope">
