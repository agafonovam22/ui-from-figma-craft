  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="order-1">
                <img 
                  ...
                  style={brandSlug === 'true' ? { height: '300px' } : brandSlug === 'smith' ? { height: '260px' } : { height: '500px' }}
                />
              </div>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="order-1 lg:order-2">
                <img 
                  ...
                  className="w-full object-cover rounded-lg"
                  style={{ height: 'calc(100% - 100px)', maxHeight: '250px' }}
                />
              </div>
            </div>
          </div>
        ...
        <section className="w-full py-8">
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="overflow-hidden relative rounded-lg" style={{ height: '308px' }}>
              <img 
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              ...
              <div className="order-1 lg:order-2">
                <img 
                  ...
                  className="w-full object-cover rounded-lg"
                  style={brandSlug === 'true' ? { height: '150px' } : brandSlug === 'smith' ? { height: '250px' } : { height: '200px' }}
                />
              </div>
            </div>
          </div>
