...
const Brand: React.FC = () => {
  ...
  const getBrandName = (slug: string) => {
    switch(slug) {
      ...
      case 'cardio-power': 
      case 'cardiopower': return 'CardioPower';
          ...
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            {brandSlug === 'smith' ? (
              ...
              <img 
                ...
                className="w-full h-auto object-cover"
              />
            ) : brandSlug === 'sole' || brandSlug === 'sole-fitness' ? (
              <img 
              ...
              />
               ...
               <img 
                 src="/lovable-uploads/c978703c-2abb-441f-8703-249e3d0e18fb.png"
              ...
              <img 
                src="/lovable-uploads/5cbee8ac-b669-4ce0-8f0d-d7eb7da2bf56.png"
                alt="SINTESI - Тренируйтесь с умом"
                className="w-full h-auto object-cover"
              />
            ) : brandSlug === 'kernel' ? (
              <img 
              ...
              <img 
                src="/lovable-uploads/82bbe7b1-d160-4c79-bc6f-733e3cac1e57.png"
                alt="VISBODY - ИИ-сканер тела №1 в мире"
                className="w-full h-auto object-cover"
              />
            ) : (
...
{brandSlug === 'true' ? 'МЫ – TRUE' : brandSlug === 'cardio-power' ? 'CARDIO POWER' : brandSlug === 'schwinn' ? 'SCHWINN' : brandSlug === 'nautilus' ? 'NAUTILUS' : brandSlug === 'sole-fitness' ? 'SOLE FITNESS' : brandSlug === 'peach-builder' ? 'PEACH BUILDER' : brandSlug === 'gym80' ? 'GYM80' : brandSlug === 'oktan' ? 'OCTANE FITNESS' : brandSlug === 'visbody' ? 'VISBODY' : brandSlug === 'bowflex' ? 'BOWFLEX' : brandSlug === 'scholle' ? 'SCHOLLE: Немецкое качество для активного образа жизни' : brandSlug === 'smith' ? 'SMITH: профессиональное фитнес-оборудование с безупречной репутацией' : brandSlug === 'sintesi' ? 'SINTESI' : 'Качественное спортивное оборудование'}
          ...
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="order-1">
                <img 
                  src={(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? '/lovable-uploads/43048f4e-3614-48d5-9494-5b453360d32e.png' : brandSlug === 'true' ? '/lovable-uploads/8e338411-23e3-4016-b7ed-c88728e56c03.png' : brandSlug === 'bowflex' ? '/lovable-uploads/2047d7ac-2ac8-45b9-a8e0-ca22ab3a5013.png' : brandSlug === 'peach-builder' ? '/lovable-uploads/62839881-d0dc-4f55-81c1-2b042e81d0e3.png' : brandSlug === 'gym80' ? '/lovable-uploads/e2418140-1de7-4f5d-b34d-680fa363e740.png' : brandSlug === 'schwinn' ? '/lovable-uploads/5a7d56a3-1cee-438a-b65a-a3479013fe70.png' : brandSlug === 'oktan' ? '/lovable-uploads/b7860c53-38e6-490f-a402-9811296c1da3.png' : brandSlug === 'visbody' ? '/lovable-uploads/7d9d40ca-b668-4029-af68-f2a22f7e589f.png' : brandSlug === 'smith' ? '/lovable-uploads/b0b6bcef-5ecb-453f-8069-a06fc41ee174.png' : brandSlug === 'slide-fit' ? '/lovable-uploads/dedbea23-0db1-4b59-a6c3-480221fe1bce.png' : brandSlug === 'scholle' ? '/lovable-uploads/2426d4bb-0cd0-41f1-8fc4-e3685ff725c7.png' : brandSlug === 'inspire' ? '/lovable-uploads/02405569-7f43-47f4-997a-7d85e0efdea8.png' : brandSlug === 'hyfit' ? '/lovable-uploads/55597898-53a4-47b5-922e-18b6483925f6.png' : brandSlug === 'maxfit' ? '/lovable-uploads/2894b742-e7cf-47d8-96a8-7d07f315ba2a.png' : brandSlug === 'meridien' ? '/lovable-uploads/bf4193a1-d807-4319-80dd-08595cce7af3.png' : brandSlug === 'sole' ? '/lovable-uploads/c3d01baa-8c32-42af-889e-7afb421fc547.png' : brandSlug === 'variosling' ? '/lovable-uploads/96bad51b-6767-4b45-b4b0-f376809947b4.png' : brandSlug === 'proski' ? '/lovable-uploads/0b48049d-d9df-45b4-baee-0c6f2702ebec.png' : brandSlug === 'kernel' ? '/lovable-uploads/51f23440-17cb-4477-a1f4-0ef7ccdb95c4.png' : brandSlug === 'centr' ? '/lovable-uploads/2b17487e-7545-405e-bdc8-e2ccc5b4cc15.png' : brandSlug === 'sintesi' ? '/lovable-uploads/bb85b094-4471-4752-a384-5518526c10f3.png' : '/lovable-uploads/bf4193a1-d807-4319-80dd-08595cce7af3.png'}
              ...
              <div className="order-2 lg:pl-8">
                ...
                {brandSlug === 'kernel' ? (
                  ...
                  <div className="mb-8">
                    <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                      Основанный на личном опыте Криса Хемсворта, CENTR — это больше чем оборудование. Это философия, объединяющая фитнес, питание и ментальное здоровье в единую систему для тех, кто стремится к балансу.
                    </p>
                  </div>
                ) : brandSlug === 'visbody' ? (
                  <div className="mb-8">
                    ...
                    <ul className="text-gray-600 text-sm leading-relaxed font-manrope ml-4 space-y-2">
                      <li>• медицинскую точность измерений</li>
                      <li>• AI-анализ осанки и состава тела</li>
                      <li>• автоматизированные рекомендации</li>
                    </ul>
                  </div>
                ) : (
                  <div className="mb-8">
                   ...
                   <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                     ...
                     <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                       PROSKI-Simulator — инновационный тренажер для круглогодичной подготовки горнолыжников и сноубордистов. Он точно воспроизводит движения реального спуска, позволяя отрабатывать технику поворотов, баланс и координацию в любое время года.
                     </p>
                    ) : brandSlug === 'variosling' ? (
                      <>
                        <p className="text-gray-600 text-sm leading-relaxed mb-6 font-manrope">
                          Компания Variosling (Германия) представляет инновационные функциональные петли.
                        </p>
                        <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                          Среди всего многообразия спортивного оборудования петли Variosling занимают особое место. Они представляют собой идеальный симбиоз инновационных технологий и проверенного немецкого качества. Это не просто тренировочные петли – это целая философия функционального тренинга, воплощенная в компактном и мобильном формате.
                        </p>
                      </>
                    ) : brandSlug === 'visbody' ? (
                      <>
                        <p className="text-gray-600 text-sm leading-relaxed mb-6 font-manrope">
                          Ведущий разработчик профессиональных 3D/4D-сканеров для анализа тела, объединяющих технологии компьютерного зрения, биоимпедансных (BIA) измерений и искусственного интеллекта. Создает революционные стандарты диагностики, объединяя в одном решении: медицинскую точность измерений AI-анализ осанки и состава тела автоматизированные рекомендации.
                        </p>
                      </>
                    ) : (
                    <>
          ...
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-start">
              ...
              <div className="order-2 lg:order-1 lg:pr-8">
                <h2 className="text-3xl font-benzin text-gray-900 mb-6">
                  {(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? 'Кому подходит CardioPower?' : brandSlug === 'cardiopower-pro' ? 'Технологии для профессионалов' : brandSlug === 'schwinn' ? 'Кому подходят тренажеры Schwinn?' : brandSlug === 'nautilus' ? 'Кому подходят решения Nautilus?' : brandSlug === 'sole' || brandSlug === 'sole-fitness' ? 'Что делает Sole Fitness особенным?' : brandSlug === 'peach-builder' ? 'Для кого создан PEACH BUILDER?' : brandSlug === 'gym80' ? 'Философия GYM80' : brandSlug === 'oktan' ? 'Инновации Octane Fitness' : brandSlug === 'visbody' ? 'Visbody-S30' : brandSlug === 'bowflex' ? 'BOWFLEX ДЕЛАЕТ ТРЕНИРОВКИ ОСОБЕННЫМИ' : brandSlug === 'scholle' ? 'Надежность, проверенная временем' : brandSlug === 'smith' ? 'Инновации, проверенные временем' : brandSlug === 'slide-fit' ? 'Горнолыжный тренажер Slide&FIT Commercial Edition' : brandSlug === 'inspire' ? 'Инженерное превосходство в каждой детали' : brandSlug === 'hyfit' ? 'Главное преимущество – интеллектуальная система регулировки веса' : brandSlug === 'maxgym' ? 'Технологическое превосходство в деталях' : brandSlug === 'maxfit' ? 'Почему MAXFIT – это прорыв:' : brandSlug === 'meridien' ? 'Это не просто отдых — это ритуал' : brandSlug === 'proski' ? 'Эффективность тренировок' : brandSlug === 'variosling' ? 'Инженерное совершенство в каждой детали' : brandSlug === 'sintesi' ? 'Умные технологии для идеальной формы' : brandSlug === 'kernel' ? 'Функциональность и комфорт' : brandSlug === 'centr' ? 'Каждое изделие создано для ежедневного использования' : 'Наше оборудование выбирают:'}
                </h2>
                ...
                {(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? (
                  ...
                  <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                    ...
                    <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                      Благодаря уникальной системе нагрузки вы сможете имитировать любые повороты и траектории. Всего 10 минут занятий заменяют 500 полноценных виражей на склоне, что соответствует 3-5 спускам.
                    </p>
                  ) : brandSlug === 'slide-fit' ? (
                   <>
                     <p className="text-gray-600 text-sm leading-relaxed mb-6 font-manrope">
                    ...
                    <div className="space-y-4">
                     ...
                     <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                       Особенность петель Variosling заключается в их продуманной конструкции. Ленты обеспечивают необходимую эластичность и долговечность. Карабины из алюминия или нержавеющей стали гарантируют абсолютную безопасность во время тренировок. Специальные ленты, соответствующие строгому немецкому стандарту, делают оборудование не только прочным, но и экологически безопасным.
                     </p>
                    ) : brandSlug === 'kernel' ? (
                      <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                        Каждый тренажер продуман до мелочей: регулируемая нагрузка, нескользящие поверхности, прочные материалы. Занимайтесь кардио, силовыми или растяжкой — оборудование адаптируется под ваши цели.
                      </p>
                    ) : brandSlug === 'centr' ? (
                      <div className="space-y-4">
                        <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                          выдерживает интенсивные нагрузки, при этом оставаясь эргономичным и безопасным. Мы разрабатываем оборудование, которое:
                        </p>
                        <ul className="text-gray-600 text-sm leading-relaxed font-manrope ml-4 space-y-2">
                          <li>• Стимулирует регулярные тренировки продуманным дизайном</li>
                          <li>• Интегрируется с персонализированным коучингом через приложение</li>
                          <li>• Помогает достигать целей — от базовой активности до спортивных рекордов</li>
                        </ul>
                      </div>
                    ) : brandSlug === 'visbody' ? (
                      <div className="space-y-6">
              ...
              <div className="order-1 lg:order-2">
                <img 
                  src={(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? '/lovable-uploads/cd926a64-7397-490f-ac17-27c10299f206.png' : brandSlug === 'true' ? '/lovable-uploads/69d67847-9d67-4d72-9fc0-b898a33839d2.png' : brandSlug === 'bowflex' ? '/lovable-uploads/abdacbbf-5832-4529-8765-9c69eeb45ef8.png' : brandSlug === 'peach-builder' ? '/lovable-uploads/769683fd-be5a-426c-83b4-126c0b9ab58c.png' : brandSlug === 'gym80' ? '/lovable-uploads/c7015807-1028-470c-acbb-db73c3b5f2b8.png' : brandSlug === 'schwinn' ? '/lovable-uploads/6e0ee794-cc9c-4134-90b0-3760dd16638c.png' : brandSlug === 'oktan' ? '/lovable-uploads/6b0d5cba-7d6c-4f31-a309-5f2e0d37d4ca.png' : brandSlug === 'visbody' ? '/lovable-uploads/d23a0970-0190-4dfa-9f86-50d8be949773.png' : brandSlug === 'smith' ? '/lovable-uploads/89e43cee-27a7-4c9a-a2fa-8ec80e691fc1.png' : brandSlug === 'slide-fit' ? '/lovable-uploads/10b8625a-84e0-498f-8c8a-9833e27f8c21.png' : brandSlug === 'scholle' ? '/lovable-uploads/21d5460d-d369-4ca7-8f1e-ad4cddb57119.png' : brandSlug === 'inspire' ? '/lovable-uploads/d445537d-858a-465c-a8aa-1bb673b978ab.png' : brandSlug === 'hyfit' ? '/lovable-uploads/5b1409c4-d728-4894-a5f4-5e410a91eab8.png' : brandSlug === 'maxfit' ? '/lovable-uploads/8ef08ada-72dc-49cf-8a23-1427d9886029.png' : brandSlug === 'meridien' ? '/lovable-uploads/03810138-7d8b-4b47-8c17-354d672fe3ff.png' : brandSlug === 'sole' ? '/lovable-uploads/d34da0dc-f6a4-4fcc-aa86-fe80145b27e7.png' : brandSlug === 'variosling' ? '/lovable-uploads/4e28c56a-50f5-4a77-b715-aff62a12bf6d.png' : brandSlug === 'proski' ? '/lovable-uploads/c3e6ac4c-6174-46d8-acb4-d5921af596ce.png' : brandSlug === 'kernel' ? '/lovable-uploads/68b165b2-41f2-4642-8165-a9a0145fe554.png' : brandSlug === 'centr' ? '/lovable-uploads/fc28babd-4d7a-4281-9177-62924371423d.png' : brandSlug === 'sintesi' ? '/lovable-uploads/db64ed55-9fb8-4d7e-b230-833e5ee095d8.png' : '/lovable-uploads/25a08481-5846-4c6a-8f84-9089de2749fd.png'}
        ...
        <section className="w-full py-8">
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="overflow-hidden relative rounded-lg" style={{ height: '350px' }}>
              <img 
                src={(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? "/lovable-uploads/de5c02f5-4b33-4ebf-91e6-cf221cae5ccf.png" : brandSlug === 'true' ? "/lovable-uploads/de89d231-771d-4288-af42-6ed99213ee24.png" : brandSlug === 'bowflex' ? "/lovable-uploads/fcc40dab-a503-4aae-ae77-a8b93bd0a30d.png" : brandSlug === 'peach-builder' ? "/lovable-uploads/f5a28d98-6ba4-48b2-84c4-45f27a4ad81c.png" : brandSlug === 'gym80' ? "/lovable-uploads/08d1344d-ca43-44d2-b953-28d3cb4c83d2.png" : brandSlug === 'schwinn' ? "/lovable-uploads/df10970b-3001-4bd2-85b9-1a306850b1da.png" : brandSlug === 'oktan' ? "/lovable-uploads/cd54ddcf-333b-4408-ab25-a7e2c382f6d7.png" : brandSlug === 'visbody' ? "/lovable-uploads/b96e0b1b-882f-4f65-9ee6-2800b2d2b0bb.png" : brandSlug === 'smith' ? "/lovable-uploads/21dacae0-6b25-4a75-adcd-e70046ff48ce.png" : brandSlug === 'slide-fit' ? "/lovable-uploads/2df24fd7-d22e-403e-b3b9-d57fa9210a68.png" : brandSlug === 'scholle' ? "/lovable-uploads/43ab3e0e-6584-4129-8e35-28d5587d2af5.png" : brandSlug === 'inspire' ? "/lovable-uploads/0587f7fc-182b-42bb-9efa-a0f7998bcc32.png" : brandSlug === 'hyfit' ? "/lovable-uploads/fdf2f744-537e-4cdc-b8c8-ecf68565fc47.png" : brandSlug === 'maxfit' ? "/lovable-uploads/1c4de0a0-f047-4bcd-ad2c-dea4f9a26ca1.png" : brandSlug === 'meridien' ? "/lovable-uploads/65ea8546-02c6-4913-b251-f0e3ba673bb0.png" : brandSlug === 'sole' ? "/lovable-uploads/3e328102-f1b6-4a30-86e3-fbe776c287aa.png" : brandSlug === 'variosling' ? "/lovable-uploads/1aac53c7-22d7-4c4a-a2ef-e4ea39643a42.png" : brandSlug === 'proski' ? "/lovable-uploads/ecc70f40-55ee-4151-b7f2-3f4fe70ceb86.png" : brandSlug === 'kernel' ? "/lovable-uploads/e1386551-2918-46ed-9540-3ac64cee6e17.png" : brandSlug === 'centr' ? "/lovable-uploads/675d848b-f532-4faa-ad38-29de5dcf2740.png" : brandSlug === 'sintesi' ? "/lovable-uploads/cba9799c-76c1-4732-8a0a-b2ccd7096033.png" : "/lovable-uploads/b04fa555-f20a-4548-bca0-6ff520c1c93c.png"}
                ...
                <div className="h-full flex flex-col">
                  <div className="mb-3">
                     <h2 className="text-3xl font-benzin text-gray-900 mb-3">
                       {(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? 'Почему CardioPower?' : brandSlug === 'cardiopower-pro' ? 'Управление без сложностей' : brandSlug === 'schwinn' ? 'Наследие, которому можно доверять' : brandSlug === 'nautilus' ? 'Nautilus:' : brandSlug === 'sole' || brandSlug === 'sole-fitness' ? 'Технологии, которые работают на вас:' : brandSlug === 'peach-builder' ? 'Философия бренда строится на трёх принципах:' : brandSlug === 'gym80' ? 'Более 40 лет в служении фитнесу' : brandSlug === 'oktan' ? 'Преимущества Octane Fitness' : brandSlug === 'visbody' ? 'Visbody-Creator A600' : brandSlug === 'bowflex' ? 'BOWFLEX ВДОХНОВЛЯЕТ' : brandSlug === 'scholle' ? 'Широкий ассортимент для активного отдыха' : brandSlug === 'smith' ? 'Комфорт как главный приоритет' : brandSlug === 'slide-fit' ? 'Технологическое превосходство' : brandSlug === 'inspire' ? 'Уникальные особенности тренажеров INSPIRE' : brandSlug === 'hyfit' ? 'Комплексные решения для любого уровня подготовки' : brandSlug === 'maxgym' ? 'Философия бренда' : brandSlug === 'maxfit' ? 'Для кого созданы наши тренажеры:' : brandSlug === 'meridien' ? 'Почему тысячи людей выбирают MÉRIDIEN:' : brandSlug === 'proski' ? 'Развитие ключевых навыков' : brandSlug === 'variosling' ? 'Профессиональный инструмент для различных задач' : brandSlug === 'sintesi' ? 'Три модели для любых целей' : brandSlug === 'visbody' ? 'Временная заглушка статистики' : brandSlug === 'kernel' ? 'Фитнес, который вписывается в жизнь' : brandSlug === 'centr' ? 'Наши ценности' : 'Лидер в индустрии'}
                     </h2>
                      {brandSlug === 'hyfit' ? (
                        <div className="space-y-3">
                          <div className="flex items-start">
                            ...
                            <p className="text-gray-700 text-sm leading-relaxed font-manrope">
                              Регулируемая гантель HYFIT CLASSIC – базовый элемент системы с эргономичным дизайном
                            </p>
                          </div>
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                            <p className="text-gray-700 text-sm leading-relaxed font-manrope">
                              Набор HYFIT 3в1 – штанга, гантель и гиря в едином регулируемом решении
                            </p>
                          </div>
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                            <p className="text-gray-700 text-sm leading-relaxed font-manrope">
                              Универсальная скамья – дополнение для удобства тренировок
                            </p>
                          </div>
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                            <p className="text-gray-700 text-sm leading-relaxed font-manrope">
                              Специализированные стенды – для удобного хранения и быстрого доступа
                            </p>
                          </div>
                        </div>
                      ) : (
                          <p className="text-gray-700 text-sm leading-relaxed font-manrope">
                             {(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? '' : brandSlug === 'cardiopower-pro' ? (
                              ...
                              <div className="space-y-4">
                                ...
                                <p className="text-gray-700 text-sm leading-relaxed font-manrope mb-3">
                                  <strong>Экономия на обслуживании:</strong> минимальные затраты благодаря надежной конструкции и доступности запчастей
                                </p>
                              </div>
                             ...
                             <div className="space-y-4">
                               ...
                               <p className="text-gray-700 text-sm leading-relaxed font-manrope mb-4">
                               ...
                               <div className="space-y-3">
                                 <div>
                                   <h5 className="font-benzin text-gray-900 mb-1">23 параметра бега</h5>
                                   <p className="text-gray-700 text-sm leading-relaxed font-manrope">От постановки стопы до симметрии движений и осанки</p>
                                 </div>
                                 <div>
                                   <h5 className="font-benzin text-gray-900 mb-1">18 зон</h5>
                                   <p className="text-gray-700 text-sm leading-relaxed font-manrope">Измерения, 3D-сканирование, визуализация тела до/после</p>
                                 </div>
                                 <div>
                                   <h5 className="font-benzin text-gray-900 mb-1">13 аспектов</h5>
                                   <p className="text-gray-700 text-sm leading-relaxed font-manrope">Позы бега в реальном времени с помощью технологии ИИ</p>
                                 </div>
                               </div>
                             </div>
                           ) : brandSlug === 'bowflex' ? '' : brandSlug === 'scholle' ? 'В ассортименте SCHOLLE каждый найдет оборудование по душе:' : brandSlug === 'smith' ? 'SMITH понимает, что успешные тренировки – это не только эффективность, но и удовольствие от процесса. Поэтому каждая деталь тренажеров продумана для максимального комфорта: мягкие сиденья из износостойкой синтетической кожи, нескользящие рукоятки, магнитные селекторы нагрузки, система снижения стартового сопротивления. Даже упаковка оборудования разработана специально для безопасной транспортировки – прочный гофрокартон надежно защищает тренажеры при перевозке.' : brandSlug === 'slide-fit' ? 'Тренажеры Slide&FIT оснащены несколькими уровнями нагрузки, позволяющими постепенно увеличивать интенсивность тренировок. Прочные металлические конструкции с точной балансировкой гарантируют безопасность и долговечность. Компактные размеры и мобильность делают тренажеры идеальным решением как для фитнес-клубов, так и для домашнего использования.' : brandSlug === 'inspire' ? 'Главной отличительной чертой оборудования INSPIRE является продуманная многофункциональность. Каждая машина сочетает в себе несколько тренировочных зон, позволяя прорабатывать различные группы мышц без необходимости использования дополнительных устройств.' : brandSlug === 'proski' ? 'Тренажер развивает ключевые навыки: координацию, баланс и выносливость. Он одинаково эффективен как для профессиональных спортсменов, так и для начинающих любителей.' : brandSlug === 'maxgym' ? 'MAXGYM создает оборудование, которое:' : ''}
                         </p>
                      )}
                   </div>
                  ...
                  {(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? (
                    <div className="space-y-3">
                     ...
                     <div>
                       <h3 className="font-benzin text-gray-900 mb-3">Современный подход к традиционному качеству</h3>
                       <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                      ...
                      <div className="space-y-3">
                        ...
                        <div className="space-y-4">
                         ...
                         <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                          ...
                          <div className="space-y-4">
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Мы верим, что здоровый образ жизни должен приносить радость. Оборудование CENTR — это инструмент, который:
                            </p>
                            <ul className="text-gray-600 text-sm leading-relaxed font-manrope ml-4 space-y-2">
                              <li>• Делает рутину увлекательной</li>
                              <li>• Адаптируется под ваши потребности</li>
                              <li>• Создает поддерживающую экосистему для развития</li>
                            </ul>
                          </div>
                        ) : (
        ...
        <section className="w-full py-8">
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                      ...
                      {brandSlug === 'slide-fit' ? (
                        <div className="space-y-3">
                          <div className="flex items-start">
                            ...
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Развивает все группы мышц одновременно
                            </p>
                          </div>
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Предлагает несколько видов тренировок в одном устройстве
                            </p>
                          </div>
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Сочетает кардионагрузку с силовыми упражнениями
                            </p>
                          </div>
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Подходит для пользователей любого уровня подготовки
                            </p>
                          </div>
                        </div>
                      ) : brandSlug === 'hyfit' ? (
                        <div className="space-y-3">
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Профессиональные результаты при домашних тренировках
                            </p>
                          </div>
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Экономию пространства без потери функциональности
                            </p>
                          </div>
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Возможность прогрессировать без ограничений
                            </p>
                          </div>
                          <div className="flex items-start">
                            <span className="text-green-600 font-bold mr-2">✓</span>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                              Инновационные решения в традиционном железе
                            </p>
                          </div>
                        </div>
                      ) : brandSlug === 'maxfit' ? (
                        <div className="space-y-4">
                          <div className="space-y-3">
                            <div className="flex items-start">
                              <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                              <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                                450+ успешными инсталляциями
                              </p>
                            </div>
                            <div className="flex items-start">
                              <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                              <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                                Сертификатами CE, ROHS, EN957, ISO9001:2015
                              </p>
                            </div>
                            <div className="flex items-start">
                              <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                              <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                                Тестированием в престижных клубах и резиденциях
                              </p>
                            </div>
                          </div>
                          <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                          Мы используем проверенные материалы и технологии, чтобы ваши тренировки были не только эффективными, но и безопасными.
                        </p>
                      ) : brandSlug === 'centr' ? (
                        <div className="space-y-3">
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">Для тех, кто ценит системный подход к здоровью</p>
                          </div>
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                            <p className="text-gray-600 text-sm leading-relaxed font-manrope">Для занятых людей, предпочитающих домашние тренировки</p>
                          </div>
                          <div className="flex items-start">
                            <div className="w-2 h-2 bg-[#F53B49] rounded-full mt-2 mr-3 flex-shrink-0"></div>
                        ...
                        <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                           {(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? 'CardioPower – это преемственность традициям качества. Наша продукция собирается из самых качественных комплектующих и проходит многоэтапную систему контроля качества. Наши тренажеры рассчитаны на долгосрочную службу в условиях интенсивной эксплуатации. Мы уделяем особое внимание работе послепродажного сервиса, обеспечивая оперативную техническую поддержку и наличие склада запасных частей.' : brandSlug === 'cardiopower-pro' ? 'Наше оборудование проходит многоступенчатое тестирование: от проверки каждой детали до 24/7 тестов на износ. Результат — тренажеры, которые сохраняют безупречную работу при экстремальных нагрузках. Гарантия на раму и сертификаты международных стандартов — подтверждение нашего подхода к качеству.' : brandSlug === 'true' ? 'TRUE – это не просто тренажеры, это инвестиция в долгосрочный результат. Наше оборудование выбирают, потому что оно: Работает безотказно – даже при интенсивной эксплуатации; Сохраняет актуальность – регулярные апгрейды и совместимость с новыми технологиями; Обеспечивает максимальный комфорт – продуманная эргономика снижает нагрузку на суставы.' : brandSlug === 'bowflex' ? 'Bowflex — это не просто оборудование. Это поддержка и комфорт, которые всегда с вами, помогая двигаться к своим целям. Каждый человек выбирает свой путь, свой стиль и свои любимые упражнения — у нас есть решения для каждого. Что бы вас ни мотивировало, с Bowflex вы сможете двигаться так, как нравится именно вам. Мы создаём тренажёры, которые делают фитнес доступным и вдохновляющим. Дома, в своем ритме и на своих условиях. Просто начните, и вы почувствуете разницу. Bowflex — для тех, кто выбирает движение.' : brandSlug === 'schwinn' ? 'От компактных велотренажеров для небольших квартир до профессиональных эллипсоидов с плавным ходом — ассортимент Schwinn охватывает весь спектр домашнего кардиооборудования. Особой популярностью пользуются гибридные модели, сочетающие в себе функции нескольких тренажеров, позволяя разнообразить тренировочный процесс.' : brandSlug === 'sole' || brandSlug === 'sole-fitness' ? '' : brandSlug === 'inspire' ? 'INSPIRE предлагает полный спектр оборудования для профессионального и домашнего использования:\nМногофункциональные силовые станции\nКардиотренажеры\nСкамьи и стойки\nРамы и машины Смита\nСпециализированные мультистанции\nПрофессиональные тренеры выбирают INSPIRE за безупречное качество и продуманную эргономику. Владельцы фитнес-клубов ценят надежность и долговечность, снижающие эксплуатационные расходы. Для домашних пользователей бренд предлагает компактные решения, сочетающие в себе функциональность профессионального оборудования с удобством бытового использования.' : brandSlug === 'maxgym' ? 'MAXGYM - это профессиональные решения для владельцев фитнес-клубов, тренеров и спортсменов, которые ищут оптимальное сочетание цены и качества без ущерба для функциональности.' : brandSlug === 'proski' ? 'PROSKI-Simulator — это не просто тренажер, а ваш персональный тренер. Он поможет поддерживать идеальную форму и безупречную технику круглый год!' : brandSlug === 'variosling' ? 'Variosling можно назвать идеальным решением для тех, кто ценит мобильность. Они легко помещаются в рюкзак и могут сопровождать вас в путешествиях, командировках или на отдыхе. Простота крепления (к потолочным крюкам, турникам или дверным проемам) делает тренировки доступными практически в любом месте.' : brandSlug === 'peach-builder' ? 'PEACH BUILDER — это больше чем оборудование. Это философия тренировок нового поколения, где красота встречается с функциональностью, а мечты о идеальной форме становятся реальностью. Выбирая эти тренажёры, вы выбираете путь к телу, которое будет вдохновлять.' : brandSlug === 'scholle' ? 'SCHOLLE сочетает в своей продукции проверенные временем технологии и современные разработки. Особенностью бренда является продуманная эргономика: будь то система регулировки инверсионного стола или антискользящее покрытие ручек баскетбольных щитов.\n\nВыбирая SCHOLLE, вы приобретаете не просто спортивный инвентарь, а надежного спутника для поддержания активного образа жизни всей семьи. Это оборудование, которое годами сохраняет свои потребительские свойства, доказывая, что немецкое качество — не просто слова, а стандарт, которому стоит доверять.\n\nС десятилетним опытом на рынке SCHOLLE продолжает развиваться, оставаясь верным своим принципам: безопасность, надежность и доступность качественного спортивного оборудования для каждого дома.' : brandSlug === 'sintesi' ? 'Sintesi не просто заменяет тренажеры — она делает тренировки умнее. Автоматическая настройка, детальная статистика и адаптация под ваши цели экономят время и повышают результат.' : brandSlug === 'visbody' ? 'Это временная заглушка текста для бренда Visbody. Здесь будет размещена подробная информация о технологиях и возможностях данного бренда.' : 'Производственные стандарты SMITH – это отдельная история. Рамы из высокопрочной стали с овальным профилем, двойное порошковое покрытие для защиты от повреждений, тросы, тестируемые трижды в день под нагрузкой 900 кг – такие требования к качеству говорят сами за себя. Бренд не экономит на материалах и контроле, поэтому его оборудование служит годами даже при интенсивной эксплуатации в коммерческих залах.'}
                        </p>
                      )}
                    </div>
                </div>
              ...
              <div className="order-1 lg:order-2">
                <img 
                  src={(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? '/lovable-uploads/0351a9aa-2198-4d0c-bb47-b3be6eb6c598.png' : brandSlug === 'true' ? '/lovable-uploads/f0b8744d-a5e4-418e-9512-534ed70c17e6.png' : brandSlug === 'bowflex' ? '/lovable-uploads/5fcc7191-4a4d-4420-9f97-129a5ffd9ffd.png' : brandSlug === 'peach-builder' ? '/lovable-uploads/8c98a766-d4d6-4168-b6d0-bbe7afeae853.png' : brandSlug === 'gym80' ? '/lovable-uploads/08975827-d091-4c00-9cb5-85e93a4b1853.png' : brandSlug === 'schwinn' ? '/lovable-uploads/af9da9ea-dbaa-4e9f-ae2f-831cda031eba.png' : brandSlug === 'oktan' ? '/lovable-uploads/52c07468-4317-41f4-8313-bcc245be5785.png' : brandSlug === 'visbody' ? '/lovable-uploads/0fa25459-bf51-49a6-a3c6-6a652a3e2220.png' : brandSlug === 'smith' ? '/lovable-uploads/71d0385e-1371-49ab-9a7d-e7deca9fb911.png' : brandSlug === 'slide-fit' ? '/lovable-uploads/20c74b65-af59-4385-a213-f539a5f32a01.png' : brandSlug === 'scholle' ? '/lovable-uploads/d9184a48-7f14-4d51-820d-28a8ae120202.png' : brandSlug === 'inspire' ? '/lovable-uploads/66bc8bfb-2485-4e5a-895b-ea2574f1ced3.png' : brandSlug === 'hyfit' ? '/lovable-uploads/d04c4990-cf91-48ab-a5f3-3c5d9069ccde.png' : brandSlug === 'maxfit' ? '/lovable-uploads/0405797d-8a30-49fd-94dc-883f4987067b.png' : brandSlug === 'meridien' ? '/lovable-uploads/bccb9570-9519-4d88-a3b7-061c75d83b7a.png' : brandSlug === 'sole' ? '/lovable-uploads/073fb559-e915-428d-ad42-cd1dd4291464.png' : brandSlug === 'variosling' ? '/lovable-uploads/9edd9a42-8036-42e3-84e9-2220d64397f7.png' : brandSlug === 'proski' ? '/lovable-uploads/bf6c99fa-b724-429c-ba43-f71983cddee5.png' : brandSlug === 'kernel' ? '/lovable-uploads/e3c084a7-22dc-4b04-a7b8-370ed4086f05.png' : brandSlug === 'centr' ? '/lovable-uploads/c5e75b4d-2b6f-4309-969b-2f1439d0edc4.png' : brandSlug === 'sintesi' ? '/lovable-uploads/c0dbfaa6-5eab-41cf-9b35-cac578e53882.png' : '/lovable-uploads/61aab835-fb0d-4b1e-a7b4-70a5ff2c4cf7.png'}
                   alt="Качество и надежность TRUE"
                   className="w-full object-cover rounded-lg"
                   style={brandSlug === 'true' ? { height: '230px' } : brandSlug === 'smith' ? { height: '350px' } : brandSlug === 'bowflex' ? { height: '230px' } : { height: '350px' }}
                />
              </div>
            </div>
          </div>
              ...
              <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  ...
                  <div className="order-2 lg:order-1">
                    <img 
                      src="/lovable-uploads/dfcceb4d-3e07-4941-8124-1a9a979d8e2f.png"
        ...
        {/* Fifth Content Block - KERNEL Block 5 */}
        {brandSlug === 'kernel' && (
          <section className="w-full py-8">
            <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                ...
                <div className="order-2 lg:pl-8">
                  <h2 className="text-3xl font-benzin text-gray-900 mb-6">
                    Спорт начинается дома и продолжается в зале
                  </h2>
                  <p className="text-gray-600 text-sm leading-relaxed font-manrope">
                    С нашими тренажерами вы создаете персональный зал там, где вам удобно. Просто начните.
                  </p>
                </div>
              </div>
            </div>
        ...
        {/* Fifth Content Block - CENTR Block 5 */}
        {brandSlug === 'centr' && (
          <section className="w-full py-8">
            <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
