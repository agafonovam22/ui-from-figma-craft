  ...
  return (
    <div className="min-h-screen bg-white">
      ...
      <main className="w-full">
        ...
        <section className="w-full py-8">
          <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
            <div className="overflow-hidden relative rounded-lg" style={{ height: (brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? '350px' : '250px' }}>
              <img 
              ...
              <div className="absolute top-2.5 right-2.5 bottom-2.5 w-[650px] bg-white rounded-lg p-4 shadow-lg overflow-y-auto">
               ...
               <div className="order-1 lg:order-2">
                  <img 
                    ...
                    alt="Спортивные тренировки"
                    className="w-full object-cover rounded-lg"
                    style={brandSlug === 'true' ? { height: '300px' } : brandSlug === 'smith' ? { height: '250px' } : brandSlug === 'bowflex' ? { height: '150px' } : brandSlug === 'variosling' ? { height: '250px' } : { height: '500px' }}
                 />
               </div>
             </div>
           </div>
              ...
              <div className="order-1 lg:order-2">
                <img 
                  src={(brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? '/lovable-uploads/0351a9aa-2198-4d0c-bb47-b3be6eb6c598.png' : brandSlug === 'true' ? '/lovable-uploads/f0b8744d-a5e4-418e-9512-534ed70c17e6.png' : brandSlug === 'bowflex' ? '/lovable-uploads/5fcc7191-4a4d-4420-9f97-129a5ffd9ffd.png' : brandSlug === 'peach-builder' ? '/lovable-uploads/8c98a766-d4d6-4168-b6d0-bbe7afeae853.png' : brandSlug === 'gym80' ? '/lovable-uploads/08975827-d091-4c00-9cb5-85e93a4b1853.png' : brandSlug === 'schwinn' ? '/lovable-uploads/af9da9ea-dbaa-4e9f-ae2f-831cda031eba.png' : brandSlug === 'oktan' ? '/lovable-uploads/52c07468-4317-41f4-8313-bcc245be5785.png' : brandSlug === 'visbody' ? '/lovable-uploads/5c83f7c6-b329-4314-b2f2-d9c78efdb039.png' : brandSlug === 'smith' ? '/lovable-uploads/71d0385e-1371-49ab-9a7d-e7deca9fb911.png' : brandSlug === 'slide-fit' ? '/lovable-uploads/20c74b65-af59-4385-a213-f539a5f32a01.png' : brandSlug === 'scholle' ? '/lovable-uploads/d9184a48-7f14-4d51-820d-28a8ae120202.png' : brandSlug === 'inspire' ? '/lovable-uploads/66bc8bfb-2485-4e5a-895b-ea2574f1ced3.png' : brandSlug === 'hyfit' ? '/lovable-uploads/d04c4990-cf91-48ab-a5f3-3c5d9069ccde.png' : brandSlug === 'maxfit' ? '/lovable-uploads/0405797d-8a30-49fd-94dc-883f4987067b.png' : brandSlug === 'meridien' ? '/lovable-uploads/bccb9570-9519-4d88-a3b7-061c75d83b7a.png' : brandSlug === 'sole' ? '/lovable-uploads/073fb559-e915-428d-ad42-cd1dd4291464.png' : brandSlug === 'variosling' ? '/lovable-uploads/9edd9a42-8036-42e3-84e9-2220d64397f7.png' : '/lovable-uploads/61aab835-fb0d-4b1e-a7b4-70a5ff2c4cf7.png'}
                   ...
                   className="w-full object-cover rounded-lg"
                   style={brandSlug === 'true' ? { height: '230px' } : brandSlug === 'smith' ? { height: '250px' } : brandSlug === 'bowflex' ? { height: '230px' } : (brandSlug === 'variosling') ? { height: '250px' } : (brandSlug === 'cardio-power' || brandSlug === 'cardiopower') ? { height: '350px' } : { height: '200px' }}
                />
              </div>
            </div>
          </div>
