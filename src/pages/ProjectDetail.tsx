              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-6 text-gray-700 font-manrope">
                    ...
                    ) : projectSlug === 'pulse120-anapa' ? (
                      <>
                        <p className="leading-relaxed text-base">
                          Наша компания с готовностью поучаствовала в оснащении одного из самых современных фитнес-клубов Анапы.
                        </p>
                        <p className="leading-relaxed text-base">
                    ...
                    ) : projectSlug === 'sochi-park-hotel' ? (
                      <>
                        <p className="leading-relaxed text-base">
                          Наша компания с готовностью поучаствовала в оснащении одного из самых современных фитнес-клубов Сочи.
                        </p>
                        <p className="leading-relaxed text-base">
                          Нами были предложены несколько элитных единиц оборудования gym80 что помогло создать зону особого притяжения для всего проекта.
                        </p>
