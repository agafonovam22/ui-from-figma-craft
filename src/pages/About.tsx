          ...
          <>
            ...
            <section className="pb-8 bg-white">
              <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
                ...
                <p className="text-gray-700 text-base mb-6 leading-relaxed font-manrope text-justify md:text-sm md:leading-normal md:text-left">
                ...
                <div className="col-span-12 md:col-span-6">
                  ...
                  >
                    ...
                    <div className="p-6">
                      ...
                      <h3 className="font-benzin-semibold text-lg mb-3 group-hover:text-[#F53B49] transition-colors line-clamp-2 leading-tight">
                        {newsItems[0]?.title}
                      </h3>
                      
                      <p className="font-manrope text-sm text-gray-600 line-clamp-3 leading-relaxed">
                  ...
                  <div className="h-[250px] mb-[10px]">
                    ...
                    >
                      ...
                      <div className="p-4 h-[150px] flex flex-col justify-between bg-gray-50">
                        ...
                        <h3 className="font-benzin-semibold text-sm mb-2 group-hover:text-[#F53B49] transition-colors line-clamp-2 leading-tight">
                          {newsItems[1]?.title}
                        </h3>
                        
                        <p className="font-manrope text-xs text-gray-600 line-clamp-3 leading-relaxed">
              ...
              {newsItems.length > 4 && (
                <>
                  ...
                  {newsItems.slice(8, 11).length > 0 && (
                    <div className={`grid gap-[10px] mb-8 ${newsItems.slice(8, 11).length === 3 ? 'grid-cols-3' : newsItems.slice(8, 11).length === 2 ? 'grid-cols-2' : 'grid-cols-1'}`}>
