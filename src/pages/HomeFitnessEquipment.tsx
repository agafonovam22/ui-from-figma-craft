  ...
  return (
    <main className="min-h-screen bg-white">
      ...
      <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px] py-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-[10px] mb-6 [&>*]:h-[calc(324px-50px)] [&_img]:max-h-[200px] [&_img]:w-full [&_img]:object-contain">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-[10px] mb-12 [&>*]:h-[calc(324px-50px)] [&_img]:max-h-[200px] [&_img]:w-full [&_img]:object-contain">
