            ...
            <div className="flex gap-12 items-stretch">
              <div className="flex-1 flex flex-col">
                <p className="text-gray-600 mb-6 font-manrope">
                  Для быстрого решения вашего вопроса просим внимательно заполнить все поля формы. Особенно важно указать серийный номер оборудования – это поможет нам оперативно обработать вашу заявку. Если номер найти не удалось, просто оставьте соответствующее поле пустым — мы обязательно вам поможем!
                </p>
                  ...
                  {videoInstructions.map((video) => (
                    <div key={video.id} className="relative group cursor-pointer">
                      <div className="relative overflow-hidden rounded-lg">
                        ...
                        <div className="absolute bottom-[5px] left-[5px] right-[5px] bg-white p-4 flex items-center justify-between">
