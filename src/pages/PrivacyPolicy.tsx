      ...
      <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px] py-8">
        ...
        {/* Content */}
            <div className="prose prose-gray max-w-none text-sm space-y-6">
              ...
              <section>
                <h2 className="text-xl font-benzin-semibold text-[#17171E] mb-4">2. Основные понятия, используемые в Политике</h2>
                ...
                <div className="space-y-3">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">2.11</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">2.12</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">2.13</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">2.14</h3>
                    <p className="text-gray-600 leading-relaxed">
              ...
              <section>
                <h2 className="text-xl font-benzin-semibold text-[#17171E] mb-4">3. Основные права и обязанности Оператора</h2>
                
                <div className="space-y-4">
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">3.1 Оператор имеет право:</h3>
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">3.2 Оператор обязан:</h3>
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
              ...
              <section>
                <h2 className="text-xl font-benzin-semibold text-[#17171E] mb-4">4. Основные права и обязанности субъектов персональных данных</h2>
                
                <div className="space-y-4">
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">4.1 Субъекты персональных данных имеют право:</h3>
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">4.2 Субъекты персональных данных обязаны:</h3>
                    <ul className="list-disc pl-6 space-y-2 text-gray-600">
              ...
              <section>
                <h2 className="text-xl font-benzin-semibold text-[#17171E] mb-4">5. Оператор может обрабатывать следующие персональные данные Пользователя</h2>
                
                <div className="space-y-3">
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">5.1</h3>
                    <p className="text-gray-600 leading-relaxed">Фамилия, имя, отчество.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">5.2</h3>
                    <p className="text-gray-600 leading-relaxed">Электронный адрес.</p>
                  </div>
                  
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">5.3</h3>
                    <p className="text-gray-600 leading-relaxed">Номера телефонов.</p>
                  </div>
              ...
              <section>
                <h2 className="text-xl font-benzin-semibold text-[#17171E] mb-4">14. Заключительные положения</h2>
                
                <div className="space-y-3">
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">14.1</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">14.2</h3>
                    <p className="text-gray-600 leading-relaxed">
                  ...
                  <div>
                    <h3 className="font-benzin text-[#17171E] mb-2">14.3</h3>
                    <p className="text-gray-600 leading-relaxed">
