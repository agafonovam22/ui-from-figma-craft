        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="flex items-center gap-6 mb-8">
              ...
              <div className="flex items-center gap-3">
                <div className="w-8 h-8 bg-red-500 text-white rounded flex items-center justify-center text-sm font-medium">
                  2
                </div>
                <div className="flex items-center gap-2">
                  <CreditCard className="w-5 h-5 text-red-500" />
                  <span className="font-medium text-red-500">Способ оплаты</span>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium text-red-500">Ваши данные</span>
                </div>
              </div>
            </div>
            ...
            <div className="flex gap-4">
              <Button className="bg-[#F53B49] hover:bg-[#e63946] text-white px-8 py-3 text-lg font-medium">
                Далее
              </Button>
