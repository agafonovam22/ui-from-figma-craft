              ...
              <>
                <div className="bg-white">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                    ...
                    <div 
                      className={`border-2 rounded-lg p-6 cursor-pointer transition-colors bg-white flex flex-col ${
                    ...
                    >
                      ...
                      <p className="text-gray-600 mb-6 flex-grow">Забрать завтра 14 июля, после 19:00<br/>или в течение 14 дней</p>
                      <div className={`w-full px-4 py-3 rounded text-center font-medium ${
                    ...
                    >
                      ...
                      <p className="text-gray-600 mb-6 flex-grow">Забрать 20 июля</p>
                      <div className={`w-full px-4 py-3 rounded text-center font-medium ${
                    ...
                    >
                      ...
                      <p className="text-gray-600 mb-6 flex-grow">Забрать 20 июля<br/><strong>Бесплатно от 30 001 ₽</strong></p>
                      <div className={`w-full px-4 py-3 rounded text-center font-medium ${
