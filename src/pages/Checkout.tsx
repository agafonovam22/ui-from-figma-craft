          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            {currentStep === 2 && (
              <div className="bg-white">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[10px] mb-6 p-[10px]">
                  {/* Card Online */}
                  <div 
                  ...
                  >
                    ...
                    <div className="flex gap-2 mt-3">
                      <img src="/lovable-uploads/64e04db0-d8de-4f05-aeb4-ba846428991a.png" alt="MasterCard" className="h-4 w-8 object-contain" />
                      <img src="/lovable-uploads/d353ace6-d49a-497f-9d37-214687f3fad1.png" alt="Visa" className="h-4 w-8 object-contain" />
                      <img src="/lovable-uploads/6980b75c-3745-4f41-a47d-dfcca8349bae.png" alt="МИР" className="h-4 w-8 object-contain" />
                      <img src="/lovable-uploads/de7bb264-d943-4341-99bd-204c3ba894c8.png" alt="Халва" className="h-4 w-8 object-contain" />
                    </div>
                  </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-[10px] p-[10px]">
                  {/* Invoice Payment */}
                  <div 
                    className={`border-2 rounded-lg p-4 cursor-pointer transition-colors ${
