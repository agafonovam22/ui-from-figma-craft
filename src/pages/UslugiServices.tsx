              ...
              <div className="bg-white border border-gray-200 rounded-lg p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                  <div className="text-center p-4">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-2">Финансовый анализ</h4>
                    <p className="text-gray-600 text-sm">Детальные расчеты доходов, расходов и окупаемости проекта</p>
                  </div>
                  <div className="text-center p-4">
                    <div className="w-16 h-16 bg-brand-red rounded-full flex items-center justify-center mx-auto mb-4">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-2">Анализ целевой аудитории</h4>
                    <p className="text-gray-600 text-sm">Исследование потребностей и предпочтений клиентов</p>
                  </div>
                  <div className="text-center p-4">
                    <div className="w-16 h-16 bg-brand-red rounded-full flex items-center justify-center mx-auto mb-4">
                      <svg className="w-8 h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    ...
                    <h4 className="font-semibold text-gray-900 mb-2">Концепция клуба</h4>
                    <p className="text-gray-600 text-sm">Разработка уникального позиционирования и услуг</p>
                  </div>
                </div>
              </div>

              {/* Block 3 - Contact Form */}
              <div className="bg-gradient-to-r from-gray-800 to-gray-600 rounded-lg p-8 text-white">
                <div className="max-w-2xl mx-auto text-center">
                  <h3 className="text-2xl font-bold mb-4">
                    Готовы получить профессиональный бизнес-план?
                  </h3>
                  <p className="text-gray-300 mb-6">
                    Оставьте заявку, и наши эксперты свяжутся с вами для обсуждения деталей проекта
                  </p>
                  <Button className="bg-brand-red hover:bg-brand-red-hover text-white px-8 py-3 text-lg font-semibold rounded-lg">
