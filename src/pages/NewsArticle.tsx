              ...
              <div className="space-y-6">
                ...
                <div className="space-y-6 text-gray-700">
                  <p className="leading-relaxed text-base">
                    В минувшие выходные в Сколково, в БЦ «Альматея» прошло крупнейшее мероприятие Фитнес.Россия: бизнес-форум, фитнес-конвенция, выставка. В рамках выставки команда WellFitness PRO представила свои лучшие образцы тренажеров для фитнес-клубов от таких мировых брендов как TRUE и Octane.
                  </p>
                  <p className="leading-relaxed text-base">
                    В частности, был показан популярный сегодня вид тренажеров-лестниц TRUE Palisade, с мощной конструкцией, защищающий от пота высотой ступеней 33см, широкими ступенями, двойной системой безопасности и различными вариантами консолей. Самые трендовые тренажеры от Octane - AirDyne X и гребной тренажер RO – как всегда привлекли много внимания.
                  </p>
                  <p className="leading-relaxed text-base">
                    Но максимально масштабно на стенде был представлен бренд Smith, с новой серией кардиотренажеров и очень успешными новинками рынка: Жимом ногами, Мультибабочкой, Сдвоенной тягой. Также впервые была представлена серия скамей и стоек Revolution от Smith. Следите за нашими новостями и новинками!
                  </p>
                </div>
              </div>
