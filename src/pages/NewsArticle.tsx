                  ...
                  <p className="leading-relaxed text-base">
                    {articleSlug === 'novost-dlya-dilerov-wellfitness' ? 
                      ...
                      'Беговая дорожка CardioPower ТТ30' :
                         articleSlug === 'cardiopower-s55-v-prodazhe' ?
                         'Беговая дорожка CardioPower S55 имеет стильный дизайн и совершенные технические характеристики, которые выделяют данную модель как одну из лучших в своем классе. Эта модель является идеальным выбором для серьезных тренировок в домашних условиях, не уступая по техническим данным беговым дорожкам профессионального уровня. Модель оснащена высококонтрастным TFT дисплеем с расширенным программным функционалом и возможностью использования фитнес приложений.' :
                       articleSlug === 'cardiopower-s50-v-prodazhe' ?
