...
const CartPopup: React.FC<CartPopupProps> = ({ children, isOpen, onOpenChange }) => {
  ...
  return (
    <Sheet open={isOpen} onOpenChange={onOpenChange}>
      ...
      <SheetContent 
        side="right" 
        className="w-[450px] bg-white p-0 h-[50vh] top-[120px] translate-y-0 data-[state=open]:slide-in-from-right data-[state=closed]:slide-out-to-right"
        style={{ position: 'fixed', right: '60px', height: '50vh', top: '120px' }}
      >
