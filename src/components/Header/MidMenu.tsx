...
const SearchBar: React.FC<SearchBarProps> = ({ placeholder = "Поиск", onSearch, className = "" }) => {
  ...
  return (
    <div
      className={`flex flex-1 h-[41px] justify-between items-center bg-[#262631] pl-5 pr-4 py-3.5 rounded-[5px] max-w-[700px] cursor-pointer ${className}`}
    >
      <span className="flex-1 text-[#5C6476] text-sm font-normal leading-[14px]">
        {placeholder}
      </span>
