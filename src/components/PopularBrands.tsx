...
const PopularBrands: React.FC = () => {
  const brands = [
    ...
    { id: 12, name: "Scholle", logo: "/lovable-uploads/6f37c647-9b20-4850-b4f2-b31137d558ff.png", slug: "scholle" },
    { id: 13, name: "Smith", logo: "/lovable-uploads/88c44b8a-27d1-46e8-85f5-3ac95201bf35.png", slug: "smith" },
