  ...
  return (
    <div className="space-y-4">
      ...
      <div className="relative group">
        <div className="relative overflow-hidden rounded-lg bg-white min-h-[300px] md:min-h-[400px] lg:min-h-[500px] max-h-[400px] md:max-h-[500px] lg:max-h-[700px] w-full flex items-center justify-center">
          <img
            ...
            <CarouselContent className="-ml-2">
              {allImages.map((image, index) => (
                <CarouselItem key={index} className="pl-2 basis-1/4">
                    <button
                    className="relative overflow-hidden rounded-lg aspect-square transition-all w-full bg-gray-100 hover:ring-2 hover:ring-gray-300"
