      ...
      <div className="bg-[#262631] py-3">
        <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-3">
            {/* Каталог */}
            <div>
              <h3 className="text-[12px] font-semibold mb-2">Каталог</h3>
              <ul className="space-y-1.5 text-gray-300 text-[10px]">
            ...
            {/* Поддержка */}
            <div>
              <h3 className="text-[12px] font-semibold mb-2">Поддержка</h3>
              <ul className="space-y-1.5 text-gray-300 text-[10px]">
            ...
            {/* О компании */}
            <div>
              <h3 className="text-[12px] font-semibold mb-2">О компании</h3>
              <ul className="space-y-1.5 text-gray-300 text-[10px]">
            ...
            {/* Услуги */}
            <div>
              <h3 className="text-[12px] font-semibold mb-2">Услуги</h3>
              <ul className="space-y-1.5 text-gray-300 text-[10px]">
            ...
            {/* Контакты Москва */}
            <div>
              <h3 className="text-[12px] font-semibold mb-2">Для Москвы</h3>
              <div className="text-gray-300 space-y-1.5">
                <p className="text-[12px] font-semibold text-white">+7 (499) 677-56-32</p>
            ...
            {/* Контакты Россия */}
            <div>
              <h3 className="text-[12px] font-semibold mb-2">Для дома</h3>
              <div className="text-gray-300 space-y-1.5">
                <p className="text-[10px]">Для России</p>
                <p className="text-[12px] font-semibold text-white">+7 (800) 775-12-17</p>
                <p className="text-[10px]">Для дома</p>
                <p className="text-[10px]">E-mail</p>
                <p className="text-white text-[10px]">info@wellfitness.ru</p>
                <div className="flex items-center gap-1">
                  <div className="w-3 h-3 bg-gray-600 rounded-full flex items-center justify-center">
                    <span className="text-[7px]">VK</span>
                  </div>
                ...
                <div className="mt-2">
                  <button className="bg-[#F53B49] text-white px-2 py-1 rounded hover:bg-[#e63946] transition-colors text-[10px]">
                    Заказать звонок
                  </button>
                </div>
                <div className="mt-2">
                  <p className="text-[10px] mb-1">Принимаем к оплате</p>
