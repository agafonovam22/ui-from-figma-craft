...
const Footer: React.FC = () => {
  return (
    <footer className="w-full text-white">
      ...
      <div className="bg-[#262631] py-1.5">
        <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-2">
            {/* Каталог */}
            <div>
              <h3 className="text-xs font-semibold mb-1">Каталог</h3>
            ...
            {/* Поддержка */}
            <div>
              <h3 className="text-xs font-semibold mb-1">Поддержка</h3>
              <ul className="space-y-0.5 text-gray-300 text-[10px]">
            ...
            {/* О компании */}
            <div>
              <h3 className="text-xs font-semibold mb-1">О компании</h3>
              <ul className="space-y-0.5 text-gray-300 text-[10px]">
            ...
            {/* Услуги */}
            <div>
              <h3 className="text-xs font-semibold mb-1">Услуги</h3>
              <ul className="space-y-0.5 text-gray-300 text-[10px]">
            ...
            {/* Контакты Москва */}
            <div>
              <h3 className="text-xs font-semibold mb-1">Для Москвы</h3>
              <div className="text-gray-300 space-y-0.5">
                <p className="text-sm font-semibold text-white">+7 (499) 677-56-32</p>
                <div className="flex items-center gap-1">
                  <div className="w-4 h-4 bg-gray-600 rounded-full flex items-center justify-center">
                    <span className="text-[8px]">VK</span>
                  </div>
                  <div className="w-4 h-4 bg-gray-600 rounded-full flex items-center justify-center">
            ...
            {/* Контакты Россия */}
            <div>
              <h3 className="text-xs font-semibold mb-1">Для дома</h3>
              <div className="text-gray-300 space-y-0.5">
                <p className="text-[10px]">Для России</p>
                <p className="text-sm font-semibold text-white">+7 (800) 775-12-17</p>
                ...
                <div className="mt-1">
                  <p className="text-[10px] mb-0.5">Принимаем к оплате</p>
                  <div className="flex gap-0.5">
                    <div className="w-6 h-3 bg-white rounded text-[8px] flex items-center justify-center text-black font-bold">VISA</div>
                    <div className="w-6 h-3 bg-white rounded text-[8px] flex items-center justify-center text-black font-bold">VISA</div>
                    <div className="w-6 h-3 bg-white rounded text-[8px] flex items-center justify-center text-black font-bold">VISA</div>
                    <div className="w-6 h-3 bg-white rounded text-[8px] flex items-center justify-center text-black font-bold">VISA</div>
                  </div>
      ...
      {/* Bottom section with #17171E background - reduced size */}
