...
const Footer: React.FC = () => {
  return (
    <footer className="w-full text-white">
      ...
      <div className="bg-[#262631] py-1">
        <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-1.5">
            {/* Каталог */}
            <div>
              <h3 className="text-[9px] font-semibold mb-0.5">Каталог</h3>
              <ul className="space-y-0.5 text-gray-300 text-[8px]">
            ...
            {/* Поддержка */}
            <div>
              <h3 className="text-[9px] font-semibold mb-0.5">Поддержка</h3>
              <ul className="space-y-0.5 text-gray-300 text-[8px]">
            ...
            {/* О компании */}
            <div>
              <h3 className="text-[9px] font-semibold mb-0.5">О компании</h3>
              <ul className="space-y-0.5 text-gray-300 text-[8px]">
            ...
            {/* Услуги */}
            <div>
              <h3 className="text-[9px] font-semibold mb-0.5">Услуги</h3>
              <ul className="space-y-0.5 text-gray-300 text-[8px]">
            ...
            {/* Контакты Москва */}
            <div>
              <h3 className="text-[9px] font-semibold mb-0.5">Для Москвы</h3>
              <div className="text-gray-300 space-y-0.5">
                <p className="text-[10px] font-semibold text-white">+7 (499) 677-56-32</p>
            ...
            {/* Контакты Россия */}
            <div>
              <h3 className="text-[9px] font-semibold mb-0.5">Для дома</h3>
              <div className="text-gray-300 space-y-0.5">
                <p className="text-[8px]">Для России</p>
                <p className="text-[10px] font-semibold text-white">+7 (800) 775-12-17</p>
                <p className="text-[8px]">Для дома</p>
                <p className="text-[8px]">E-mail</p>
                <p className="text-white text-[8px]">info@wellfitness.ru</p>
                <div className="flex items-center gap-1">
                  <div className="w-3 h-3 bg-gray-600 rounded-full flex items-center justify-center">
                    <span className="text-[7px]">VK</span>
                  </div>
                ...
                <div className="mt-0.5">
                  <button className="bg-[#F53B49] text-white px-1.5 py-0.5 rounded hover:bg-[#e63946] transition-colors text-[8px]">
                    Заказать звонок
                  </button>
                </div>
                <div className="mt-0.5">
                  <p className="text-[8px] mb-0.5">Принимаем к оплате</p>
        ...
        <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3">
            ...
            <div className="flex flex-col items-start gap-1.5">
              ...
              />
              <span className="text-gray-300 text-[11px]">© WellFitness, 2005-2024 Все права защищены</span>
            </div>
            
            {/* Links - right aligned */}
            <div className="flex flex-col gap-1.5 text-[11px] text-gray-300 items-end">
