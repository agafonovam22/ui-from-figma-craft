...
const Footer: React.FC = () => {
  return (
    <footer className="w-full text-white">
      ...
      <div className="bg-[#262631] py-4">
        <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-6 gap-4">
            {/* Каталог */}
            <div>
              <h3 className="text-[14px] font-semibold mb-3">Каталог</h3>
            ...
            {/* Поддержка */}
            <div>
              <h3 className="text-[14px] font-semibold mb-3">Поддержка</h3>
              <ul className="space-y-2 text-gray-300 text-[12px]">
            ...
            {/* О компании */}
            <div>
              <h3 className="text-[14px] font-semibold mb-3">О компании</h3>
              <ul className="space-y-2 text-gray-300 text-[12px]">
            ...
            {/* Услуги */}
            <div>
              <h3 className="text-[14px] font-semibold mb-3">Услуги</h3>
              <ul className="space-y-2 text-gray-300 text-[12px]">
            ...
            {/* Контакты Москва */}
            <div>
              <h3 className="text-[14px] font-semibold mb-3">Для Москвы</h3>
              <div className="text-gray-300 space-y-2">
                <p className="text-[14px] font-semibold text-white">+7 (499) 677-56-32</p>
            ...
            {/* Контакты Россия */}
            <div>
              <h3 className="text-[14px] font-semibold mb-3">Для дома</h3>
              <div className="text-gray-300 space-y-2">
                <p className="text-[12px]">Для России</p>
                <p className="text-[14px] font-semibold text-white">+7 (800) 775-12-17</p>
                <p className="text-[12px]">Для дома</p>
                <p className="text-[12px]">E-mail</p>
                <p className="text-white text-[12px]">info@wellfitness.ru</p>
                <div className="flex items-center gap-1">
                  <div className="w-3 h-3 bg-gray-600 rounded-full flex items-center justify-center">
                    <span className="text-[7px]">VK</span>
                  </div>
                ...
                <div className="mt-2">
                  <button className="bg-[#F53B49] text-white px-2 py-1 rounded hover:bg-[#e63946] transition-colors text-[12px]">
                    Заказать звонок
                  </button>
                </div>
                <div className="mt-2">
                  <p className="text-[12px] mb-1">Принимаем к оплате</p>
      ...
      <div className="bg-[#17171E] py-5">
        <div className="max-w-[1800px] mx-auto px-2 sm:px-4 lg:px-[60px]">
          <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-4">
            ...
            {/* Links - right aligned */}
            <div className="flex flex-col gap-2 text-[13px] text-gray-300 items-end">
